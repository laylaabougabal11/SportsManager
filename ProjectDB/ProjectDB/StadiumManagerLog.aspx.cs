...
namespace ProjectDB
{
    public partial class StadiumManagerLog : System.Web.UI.Page
    {
        ...
        protected void loginclick(object sender, EventArgs e)
        {
            ...
            SqlCommand loginproc = new SqlCommand("CheckSM", conn);
            ...
            {
                Session["user"] = users;
                Response.Redirect("StadiumManagerPage.aspx", false);
            }
            else
            {
