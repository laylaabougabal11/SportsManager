...
namespace ProjectDB
{
    public partial class SportsAssociationManagerLog : System.Web.UI.Page
    {
        ...
        protected void loginclick(object sender, EventArgs e)
        {
            ...
            SqlCommand loginproc = new SqlCommand("CheckSAM", conn);
            ...
            {
                Response.Redirect("SportsAssociationManagerPage.aspx",false);
            }
            else
            {
